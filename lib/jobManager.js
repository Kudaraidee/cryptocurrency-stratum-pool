...
var rvnBlockTemplate = require('./rvnBlockTemplate.js');
...
var JobManager = module.exports = function JobManager(options){
    ...
    this.updateCurrentJob = !options.coin.isZCashProtocol ? function(rpcData){
    ...
    } : !options.coin.isRavenProtocol ? function(rpcData) {
        ...
        var tmpBlockTemplate = new rvnBlockTemplate(
            jobCounter.next(),
			rpcData,
			options.coin.reward,
			options.recipients,
...
/*
  this.updateCurrentJob = !options.coin.isRavenProtocol ? function (rpcData) {
    var tmpBlockTemplate = new blockTemplate(
		jobCounter.next(),
		rpcData,
		options.poolAddressScript,
